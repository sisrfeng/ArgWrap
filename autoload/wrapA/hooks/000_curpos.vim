...
fun! s:getCursorPositionForWrappedArguments(range, container, arguments) abort " {{{
...
fun! s:getCursorPositionForUnwrappedArguments(range, container, arguments) abort " {{{
